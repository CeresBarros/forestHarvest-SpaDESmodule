...
test_dir("C:/Users/cbarros.NRN/Documents/SpaDESintro/modules/forestHarvest/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/cbarros.NRN/Documents/SpaDESintro/modules/forestHarvest/tests/testthat/test-template.R")
